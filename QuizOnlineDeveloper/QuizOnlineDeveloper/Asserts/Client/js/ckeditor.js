...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) { var d = CKEDITOR.event.prototype,
        ...
        return {
            ...
            on: function(b, d, h, k, g) {
                function l(a, x, w, e) { a = { name: b, sender: this, editor: a, data: x, listenerData: k, stop: w, cancel: e, removeListener: u }; return !1 === d.call(h, a) ? !1 : a.data }

                function u() { x.removeListener(b, d) } var e = a.call(this, b); if (0 > e.getListenerIndex(d)) { e = e.listeners;
                    h || (h = this);
                    isNaN(g) && (g = 10); var x = this;
                    l.fn = d;
                    l.priority = g; for (var w = e.length - 1; 0 <= w; w--)
                        if (e[w].priority <= g) return e.splice(w + 1, 0, l), { removeListener: u };
                    ...
                    if (e) {
                        ...
                        if (w.length)
                            for (var w = w.slice(0), z, G = 0; G < w.length; G++) {
                                ...
                                } catch (t) {} else z = w[G].call(this, u, l, b, k);
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            extend: function(a) { var b = arguments.length,
                    e, c; "boolean" == typeof(e = arguments[b - 1]) ? b-- : "boolean" == typeof(e = arguments[b - 2]) && (c = arguments[b - 1], b -= 2); for (var g = 1; g < b; g++) { var n = arguments[g] || {};
                    CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(n), function(b) { if (!0 === e || null == a[b])
                            if (!c || b in c) a[b] = n[b] }) } return a },
            ...
            transformPlainTextToHtml: function(a, b) {
                ...
                if (!e) { var n = /\n{2}/g; if (n.test(c)) var d = "\x3c" + g + "\x3e",
                        l = "\x3c/" + g + "\x3e",
                        c = d + c.replace(n, function() { return l + d }) + l }
                c = c.replace(/\n/g, "\x3cbr\x3e");
                e || (c =
            ...
            array: {
                filter: function(a, b, e) { var c = [];
                    this.forEach(a, function(g, n) { b.call(e, g, n, a) && c.push(g) }); return c },
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || h.scrollLeft, c = d.$.scrollTop || h.scrollTop) : (c = w ? d.$ : h, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - n, c = f.top + c - t) } else
                    for (t = this, n = null; t && "body" != t.getName() &&
                        "html" != t.getName();) { b += t.$.offsetLeft - t.$.scrollLeft;
                        c += t.$.offsetTop - t.$.scrollTop;
                        t.equals(this) || (b += t.$.clientLeft || 0, c += t.$.clientTop || 0); for (; n && !n.equals(t);) b -= n.$.scrollLeft, c -= n.$.scrollTop, n = n.getParent();
                        n = t;
                        t = (f = t.$.offsetParent) ? new CKEDITOR.dom.element(f) : null }
                a && (f = this.getWindow(), t = a.getWindow(), !f.equals(t) && f.$.frameElement && (a = (new CKEDITOR.dom.element(f.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function t(a, b) { var c = { x: 0, y: 0 }; if (!a.is(k ? "body" : "html")) { var e = a.$.getBoundingClientRect();
                        c.x = e.left;
                        c.y = e.top }
                    e = a.getWindow();
                    e.equals(b) || (e = t(CKEDITOR.dom.element.get(e.$.frameElement), b), c.x += e.x, c.y += e.y); return c }
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) { var k = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                ...
                this._.guardRTL = function(a, b) { return (!b || !k.equals(a)) && (!r || !a.equals(r)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) } }
            var D = a ? this._.guardRTL : this._.guardLTR;
            h = g ? function(a, b) { return !1 === D(a, b) ? !1 : g(a, b) } : D;
            this.current ? e = this.current[C](!1, m, h) : (a ? e.type == CKEDITOR.NODE_ELEMENT &&
    ...
    (function() {
        ...
        function d(a, b, c, d, f) {
            function h(a, b, c, e) { var E = c ? a.getPrevious() : a.getNext(); if (e && k) return E;
                l || e ? b.append(a.clone(!0, f), c) : (a.remove(), u && b.append(a, c)); return E }

            function n() { var a, b, c, e = Math.min(S.length, p.length); for (a = 0; a < e; a++)
            ...
            function g() {
                var b = N - 1,
                    c = D && B && !m.equals(C);
                b < O - 1 || b < q - 1 || c ? (c ? a.moveToPosition(C,
            ...
            var m = a.startContainer,
                ...
                A = a.endOffset,
                M, r, D, B, v, T;
            if (l && C.type == CKEDITOR.NODE_TEXT && (m.equals(C) || m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(C))) c.append(a.document.createText(C.substring(K, A)));
            else {
                C.type == CKEDITOR.NODE_TEXT ? l ? T = !0 : C = C.split(A) : 0 < C.getChildCount() ? A >= C.getChildCount() ? (C = C.getChild(A - 1), r = !0) : C = C.getChild(A) : B = r = !0;
                m.type == CKEDITOR.NODE_TEXT ? l ? v = !0 : m.split(K) : 0 < m.getChildCount() ? 0 === K ? (m = m.getChild(K), M = !0) : m = m.getChild(K - 1) : D = M = !0;
                for (var S = m.getParents(), p = C.getParents(), N = n(),
                        O = S.length - 1, q = p.length - 1, F = c, E, ba, J, da = -1, U = N; U <= O; U++) { ba = S[U];
                    J = ba.getNext(); for (U != O || ba.equals(p[U]) && O < q ? b && (E = F.append(ba.clone(0, f))) : M ? h(ba, F, !1, D) : v && F.append(a.document.createText(ba.substring(K))); J;) { if (J.equals(p[U])) { da = U; break }
                        J = h(J, F) }
                    F = E }
                F = c;
                for (U = N; U <= q; U++)
                    if (c = p[U], J = c.getPrevious(), c.equals(S[U])) b && (F = F.getChild(0));
                    else { U != q || c.equals(S[U]) && q < O ? b && (E = F.append(c.clone(0, f))) : r ? h(c, F, !1, B) : T && F.append(a.document.createText(c.substring(0, A))); if (U > da)
                            for (; J;) J = h(J, F, !0);
                        F = E }
                l ||
                    g()
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function() {
                function a(b) {
                    ...
                    if (e.type == CKEDITOR.NODE_ELEMENT && 0 < d) { a: { for (n = e; d--;)
                                if (f = n.getChild(d).getIndex(!0), 0 <= f) { d = f; break a }
                            d = -1 }
                        d += 1 }
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        for (l = c(l); l || m;) {
                            if (l && !m) {!C && l.equals(n) && (C = !0); if (f ? l.isBlockBoundary() : !g.contains(l)) break;
                                K && "inline" == l.getComputedStyle("display") || (K = !1, C ? k = l : this.setStartBefore(l));
                                m = l.getPrevious() }
                            for (; m;)
                                    ...
                                    if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), d.test(M) && (m = null), A = /[\s\ufeff]$/.test(M);
                                        ...
                                        if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                            ...
                                            if (d.test(M)) m = null;
                                                ...
                                                for (var r = m.$.getElementsByTagName("*"), D = 0, B; B = r[D++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { m = null; break }
                                            m && (A = !!M.length)
                                        } else m = null;
                                    A && (K ? C ? k = l : l && this.setStartBefore(l) : K = !0);
                                    if (m) { A = m.getPrevious(); if (!l && !A) { l = m;
                                            m = null; break }
                                        m = A } else l = null
                                }
                            l && (l = c(l.getParent()))
                        ...
                        for (; l || m;) {
                            if (l && !m) {!C && l.equals(n) && (C = !0); if (f ? l.isBlockBoundary() : !g.contains(l)) break;
                                K && "inline" == l.getComputedStyle("display") || (K = !1, C ? u = l : l && this.setEndAfter(l));
                                m = l.getNext() }
                            for (; m;) {
                                A = !1;
                                    ...
                                    if ((0 < m.$.offsetWidth || b && m.is("br")) && !m.data("cke-bookmark"))
                                        if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                            ...
                                            if (d.test(M)) m =
                                                ...
                                                for (r = m.$.getElementsByTagName("*"), D = 0; B = r[D++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { m = null; break }
                                            m && (A = !!M.length)
                                        } else m = null
                                } else A = 1;
                                A && K && (C ? u = l : this.setEndAfter(l));
                                if (m) { A = m.getNext(); if (!l && !A) { l = m;
                                        m = null; break }
                                    m = A } else l = null
                            }
                            l && (l = c(l.getParent()))
                        }
                        k && u && (n = k.contains(u) ? u : k, this.setStartBefore(n), this.setEndAfter(n));
                        break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var v, T, S = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            p = null,
                            N = function(a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                ...
                                else if (p) return; var b = S(a);
                                b || (v = a); return b },
                            f = function(a) { var b = N(a);!b && a.is && a.is("br") && (T = a); return b };
                        l.guard = N;
                        l = l.lastBackward();
                        v = v || g;
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone();
                            l = new CKEDITOR.dom.walker(l); var O = CKEDITOR.dom.walker.whitespaces(),
                                q = CKEDITOR.dom.walker.bookmark();
                            l.evaluator = function(a) { return !O(a) && !q(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break }
                        l = this.clone();
                        l.collapse();
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (!this._.started) {
                    ...
                    k = t.endContainer.hasAscendant("pre", !0) || t.startContainer.hasAscendant("pre", !0);
                    ...
                    t.collapsed || (k = new CKEDITOR.dom.walker(t.clone()), n = CKEDITOR.dom.walker.bookmark(!0, !0), k.evaluator = n, this._.nextNode = k.next(), k = new CKEDITOR.dom.walker(t.clone()), k.evaluator = n, k = k.previous(), this._.lastNode = k.getNextSourceNode(!0, null, t.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (n = this.range.clone(), n.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), n.checkEndOfBlock() &&
                        (n = new CKEDITOR.dom.elementPath(n.endContainer, n.root), this._.lastNode = (n.block || n.blockLimit).getNextSourceNode(!0))), this._.lastNode && t.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = t.document.createText(""), this._.lastNode.insertAfter(k)), t = null);
                    this._.started = 1;
                    k = t
                }
                n = this._.nextNode;
                ...
                for (this._.nextNode = null; n;) {
                    ...
                    if (H) n.type == CKEDITOR.NODE_TEXT && f.test(n.getText()) && (H = 0);
                        ...
                        var m = n.getName();
                        if (CKEDITOR.dtd.$block[m] && "false" == n.getAttribute("contenteditable")) { d = n;
                            b(this, a, d); break } else if (n.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { if ("br" == m) H = 1;
                            else if (!k && !n.getChildCount() && "hr" != m) { d = n;
                                w = n.equals(t); break }
                            k && (k.setEndAt(n, CKEDITOR.POSITION_BEFORE_START), "br" != m && (this._.nextNode = n));
                            L = 1 } else { if (n.getFirst()) { k || (k = this.range.clone(), k.setStartAt(n, CKEDITOR.POSITION_BEFORE_START));
                                n = n.getFirst(); continue }
                            H = 1 }
                    }
                    H && !k && (k = this.range.clone(), k.setStartAt(n, CKEDITOR.POSITION_BEFORE_START));
                    w = (!L || H) && n.equals(t);
                    if (k && !L)
                        for (; !n.getNext(g) && !w;) { m = n.getParent(); if (m.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { L = 1;
                                H = 0;
                                w || m.equals(t);
                                k.setEndAt(m, CKEDITOR.POSITION_BEFORE_END); break }
                            n = m;
                            H = 1;
                            w = n.equals(t);
                            I = 1 }
                ...
                this._.nextNode || (this._.nextNode = w || d.equals(t) || !t ? null : this._getNextSourceNode(d, 1, t));
                return d
            },
    ...
    (function() {
        function a(a, b, c, d, e) {
            ...
            for (f in b) {
                m = b[f];
                m = "boolean" == typeof m ? {} : "function" == typeof m ? { match: m } : D(m);
                ...
                for (B in T) {
                    ...
                    var h = q,
                        ...
                        N = void 0;
                    n ? F = !1 : n = {};
                    for (N in g) "!" == N.charAt(0) && (N = N.slice(1), v.push(N), n[N] = !0, F = !1);
                    for (; N = v.pop();) g[N] =
                        g["!" + N], delete g["!" + N];
                    h[p] = (F ? !1 : n) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                q = f;
                B = p = r = void 0;
                for (r in T) q[r] = L(q[r]);
                h = !0;
                for (B in S) { r = S[B];
                    p = q[r];
                    n = [];
                    g = void 0; for (g in p) - 1 < g.indexOf("*") ? n.push(new RegExp("^" + g.replace(/\*/g, ".*") + "$")) : n.push(g);
                    p = n;
                    p.length && (q[r] = p, h = !1) }
                q.nothingRequired = h;
        ...
        function c(a, b, c) { if (!a.match || a.match(b)) { if (a.noProperties) return !1;
                ...
                a = a.classes;
                b = b.classes; if (a) { for (var d = !1, e = !0 === a, m = b.length; m--;)
        ...
        function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = B(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {},
                d = 0,
        ...
        function e(a) { var b, c, d, e, f = {},
                m = 1; for (a = B(a); b = a.match(p);)(c = b[2]) ? (d = x(c, "styles"), e = x(c, "attrs"), c = x(c, "classes")) : d = e = c = null, f["$" + m++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length); return f }

        function x(a, b) { var c = a.match(N[b]); return c ? B(c[1]) : null }
        ...
        function z(a, b, e, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) { a: { B = a.elementCallbacks; for (var p = 0, h = B.length, g; p < h; ++p)
                        if (g = B[p](b)) { B = g; break a }
                    B = void 0 } if (B) return B }
            if (f.doTransform && (B = a._.transformations[b.name])) { w(b); for (p = 0; p < B.length; ++p) m(a, b, B[p]);
                t(b) }
            if (f.doFilter) {
                a: {
                    ...
                    if (a || B) { w(b); if (p)
                            for (v = 0, D = p.length; v < D; ++v)
                                if (!1 === c(p[v], b, k)) { a = null; break a }
                        if (h)
                            for (v = 0, D = h.length; v < D; ++v) c(h[v], b, k); if (a)
                            for (v = 0, D = a.length; v < D; ++v) d(a[v], b, k, g); if (B)
                            for (v = 0, D = B.length; v < D; ++v) d(B[v], b, k, g);
                        a = k } else a = null
                }
                ...
                var C = b.styleBackup,
                    A, K, l = [],
                    k = [],
                    M = /^data-cke-/;v = !1;delete p.style;delete p["class"];delete b.classBackup;delete b.styleBackup;
                if (!a.allAttributes)
                    for (A in p) D[A] || (M.test(A) ? A == (K = A.replace(/^data-cke-saved-/, "")) || D[K] || (delete p[A], v = !0) : (delete p[A], v = !0));
                if (!a.allStyles || a.hadInvalidStyle) { for (A in F) a.allStyles || N[A] ? l.push(A + ":" + F[A]) : v = !0;
                    l.length && (p.style = l.sort().join("; ")) } else C && (p.style = C);
                if (!a.allClasses ||
                    a.hadInvalidClass) { for (A = 0; A < h.length; ++A)(a.allClasses || B[h[A]]) && k.push(h[A]);
                    k.length && (p["class"] = k.sort().join(" "));
                    g && k.length < g.split(/\s+/).length && (v = !0) } else g && (p["class"] = g);v && (r = 1);
        ...
        function L(a) { if (!a) return !1; if (!0 === a) return !0; var b = G(a); return function(c) { return c in a || b && c.match(b) } }
        ...
        function I(a, b, c) {
            var d = a.name;
            if (r.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(y()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
                ...
                if ("br" == b) a.previous && !H(a.previous) && (b = y(), b.insertBefore(a)), a.next && !H(a.next) && (b = y(), b.insertAfter(a)), a.replaceWithChildren();
                    ...
                    var d = a.children,
                        e;
                    b: { e = r[b]; for (var f = 0, m = d.length, q; f < m; ++f)
                            if (q = d[f], q.type == CKEDITOR.NODE_ELEMENT && !e[q.name]) { e = !1; break b }
                        e = !0 }
                    if (e) a.name = b, a.attributes = {}, c.push({ check: "parent-down", el: a });
                    else { e = a.parent; for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, p, B, m = d.length; 0 < m;) q = d[--m], f && (q.type == CKEDITOR.NODE_TEXT || q.type == CKEDITOR.NODE_ELEMENT && r.$inline[q.name]) ? (p || (p = new CKEDITOR.htmlParser.element(b), p.insertAfter(a), c.push({ check: "parent-down", el: p })), p.add(q, 0)) : (p = null, B = r[e.name] || r.span, q.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || q.type != CKEDITOR.NODE_ELEMENT || B[q.name] || c.push({ check: "el-up", el: q }));
                        a.remove() }
                }
            else d in { style: 1, script: 1 } ? a.remove() : (a.parent && c.push({ check: "it", el: a.parent }), a.replaceWithChildren())
        }

        function m(a, b, c) { var d, e; for (d = 0; d < c.length; ++d)
                if (e = c[d], !(e.check && !a.check(e.check, !1) || e.left && !e.left(b))) { e.right(b, F); break } }
        ...
        function C(a, b) {
            ...
            for (f in d)
                if ("class" == f)
                    for (c = d[f].split(/\s+/), q = a.classes.join("|"); p = c.pop();) { if (-1 == q.indexOf(p)) return !1 } else if (a.attributes[f] != d[f]) return !1;
            for (m in e)
                if (a.styles[m] !=
                    e[m]) return !1;
            return !0
        ...
        function K(a, b) { var c, d; "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? d = a : (c = a[0], d = a[1]); return [{ element: c, left: d, right: function(a, c) { c.transform(a, b) } }] }
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                } else if (CKEDITOR.tools.isArray(b)) { for (f = 0; f < b.length; ++f) m = this.allow(b[f], c, d); return m }
            ...
            applyTo: function(a, b, c, d) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-"))
                            ...
                            else if (q & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                        var c;
                        a: {
                ...
                for (; h = a.pop();)
                    if (c = h.el, c.parent) switch (g = r[c.parent.name] || r.span, h.check) {
                        case "it":
            ...
            addContentForms: function(a) { if (!this.disabled && a) { var b, c, d = [],
                        e; for (b = 0; b < a.length && !e; ++b) c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c); if (e) { for (b = 0; b < a.length; ++b) d.push(K(a[b], e));
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        ...
                        var f = void 0,
                            ...
                            h = void 0;
                        c = [];
                        for (m = 0; m < b.length; ++m) q = b[m], "string" == typeof q ? (q = q.split(/\s*:\s*/), p = q[0], B = null, h = q[1]) : (p = q.check, B = q.left, h = q.right), f || (f = q, f = f.element ? f.element : p ? p.match(/^([a-z0-9]+)/i)[0] :
                            f.left.getDefinition().element), B instanceof CKEDITOR.style && (B = A(B)), c.push({ check: p == f ? null : p, left: B, right: "string" == typeof h ? M(h) : h });
                        b = f;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                } else f = a.getDefinition(), p = f.styles, d = f.attributes || {}, p && !CKEDITOR.tools.isEmpty(p) ? (p = D(p), d.style = CKEDITOR.tools.writeCssText(p, !0)) : p = {}, f = { name: f.element, attributes: d, classes: d["class"] ? d["class"].split(/\s+/) : [], styles: p, children: [] };
                ...
                z(this, p, B, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c });
                0 < B.length ? c = !1 : ((b = f.attributes["class"]) && (f.attributes["class"] = f.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(f.attributes, p.attributes, !0), b && (f.attributes["class"] = b));
            ...
            load: function(b, c, f, h) {
                ...
                if (0 === g) e(!0);
                    ...
                    var x = function(a, b) {
                        ...
                        w = function(b, c) { a[b] = 1; var f = d[b];
                        ...
                        z = function(b) {
                            if (a[b]) x(b, !0);
                                ...
                                if (!(1 < f.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function() { if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, w(b, !0) } : (e.$.onload = function() { setTimeout(function() { e.$.onload = null;
                                            e.$.onerror = null;
                                            w(b, !0) }, 0) }, e.$.onerror = function() { e.$.onload = null;
                                        e.$.onerror = null;
                                        w(b, !1) }));
        ...
        load: function(a, d, b) {
            ...
            CKEDITOR.scriptLoader.load(h,
                function(a, e) { if (e.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + k[e[0]].join(",") + '" was not found at "' + e[0] + '".'); for (var f = 0; f < a.length; f++)
                        for (var h = k[a[f]], l = 0; l < h.length; l++) { var n = h[l];
                            g[n] = this.get(n);
                            c[n] = 1 }
                    d.call(b, g) }, this)
        }
    ...
    (function() {
        ...
        function x(a) {
            ...
            CKEDITOR.plugins.load(d.split(","), function(b) {
                ...
                for (var m in b) {
                    ...
                    if (p && (N = p.match(g)))
                        for (; p = N.pop();) CKEDITOR.error("editor-plugin-required", { plugin: p.replace(",", ""), requiredBy: m });
                    k && !a.lang[m] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? C = a.langCode : (C = a.langCode.replace(/-.*/, ""), C =
                        C != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, C) ? C : 0 <= CKEDITOR.tools.indexOf(k, "en") ? "en" : k[0]), h.langEntries && h.langEntries[C] ? (a.lang[m] = h.langEntries[C], C = null) : f.push(CKEDITOR.getUrl(h.path + "lang/" + C + ".js")));
                    e.push(C);
                    d.push(h)
                }
                CKEDITOR.scriptLoader.load(f, function() {
                    if (!a.isDestroyed() && !a.isDetached()) {
                        for (var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++)
                            for (var m = 0; m < d.length; m++) { var p = d[m];
                                0 === f && e[m] && p.lang && p.langEntries && (a.lang[p.name] = p.langEntries[e[m]]); if (p[b[f]]) p[b[f]](a) }
        ...
        function w() { var a = this.element; if (a && this.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) { var b = this.getData();
        ...
        function z(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, f, h, g, k = 0; k < a.length; k++) {
                ...
                c(l) ? (f || (f = r.getAscendant("table").clone(), f.append(r.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), h && h.equals(r) || (h =
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            _attachToForm: function() {
                ...
                d.is("textarea") && f && (f.on("submit", a), b(f.$.submit) && (f.$.submit = CKEDITOR.tools.override(f.$.submit, function(b) { return function() { a();
            ...
            getCommandKeystroke: function(a, b) { var c = "string" === typeof a ? this.getCommand(a) : a,
                    d = []; if (c) { var f = CKEDITOR.tools.object.findKey(this.commands, c),
                        e = this.keystrokeHandler.keystrokes; if (c.fakeKeystroke) d.push(c.fakeKeystroke);
                    else
                        for (var h in e) e[h] === f && d.push(h) } return b ? d : d[0] || null },
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(h, k, g) {
                function l(a) { var b; if (0 < n.length)
                        for (var c = 0; c < n.length; c++) { var d = n[c],
                                f = d.name,
                                e = CKEDITOR.dtd[f],
                                h = y.name && CKEDITOR.dtd[y.name];
                            h && !h[f] || a && e && !e[a] && CKEDITOR.dtd[a] ? f == y.name && (x(y, y.parent, 1), c--) : (b || (u(), b = 1), d = d.clone(), d.parent = y, y = d, n.splice(c, 1), c--) } }

                function u() { for (; L.length;) x(L.shift(), y) }
                ...
                function x(b, c, d) { c = c || y || t; var f = y;
                    void 0 === b.previous && (w(c, b) && (y = c, G.onTagOpen(g, {}), b.returnPoint = c = y), e(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (I = !1), "textarea" == b.name && (H = !1));
                ...
                var G = new CKEDITOR.htmlParser,
                    t = k instanceof CKEDITOR.htmlParser.element ? k : "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment,
                    n = [],
                    L = [],
                    y = t,
                    H = "textarea" == t.name,
                ...
                G.onTagOpen = function(f, e, h, g) {
                    ...
                    if (a(e)) n.push(e);
                        ...
                        if ("pre" == f) I = !0;
                        else { if ("br" == f && I) { y.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == f && (H = !0) }
                        if ("br" == f) L.push(e);
                        else {
                            for (; !(g = (h = y.name) ? CKEDITOR.dtd[h] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || y.isUnknown || g[f]);)
                                ...
                                else if (f in b && h in b) h = y.children, (h = h[h.length - 1]) && "li" == h.name || x(h = new CKEDITOR.htmlParser.element("li"), y), !e.returnPoint && (e.returnPoint = y), y = h;
                            else if (f in CKEDITOR.dtd.$listItem &&
                                !z(f, h)) G.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1);
                            else if (h in d && !z(f, h)) !e.returnPoint && (e.returnPoint = y), y = y.parent;
                ...
                G.onTagClose = function(a) {
                    ...
                    for (var c = [], d = [], f = y; f != t && f.name != a;) f._.isBlockLike || d.unshift(f), c.push(f), f = f.returnPoint || f.parent;
                    if (f != t) {
                ...
                G.onText = function(a) { if (!(y._.hasInlineStarted && !L.length || I || H) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = y.name,
                        e = b ? CKEDITOR.dtd[b] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!H && !e["#"] && b in d) G.onTagOpen(f[b] || ""), G.onText(a);
                    else { u();
                        l();
                        I || H || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a); if (w(y, a)) this.onTagOpen(g, {}, 0, 1);
                        y.add(a) } };
                G.onCDATA =
                    function(a) { y.add(new CKEDITOR.htmlParser.cdata(a)) };
                G.onComment = function(a) { u();
                    l();
                    y.add(new CKEDITOR.htmlParser.comment(a)) };
                G.parse(h);
                for (u(); y != t;) x(y, y.parent, 1);
                e(t);
                return t
            };
    ...
    (function() {
        function a(a, d) {
                ...
                return function(f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var q = [],
                            ...
                            m, r;
                        if (p)
                            for (B(p, 1) && q.push(p); p;) h(p) && (m = c(p)) && B(m) && ((r = c(m)) && !h(r) ? q.push(m) : (e(g).insertAfter(m), m.remove())), p = p.previous;
            ...
            var r = { elements: {} },
                ...
                D;
            for (D in v) "#" in H[D] || delete v[D];
            for (D in v) r.elements[D] = p(g, a.config.fillEmptyBlocks);
            r.root = p(g, !1);
        ...
        function e(a, b) { return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + z(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) }

        function x(a) { return a.replace(S, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function t(a, b) {
            ...
            for (var p = 0; p < d.length; p++) a = a.replace(d[p], function(a) { a = a.replace(f, function(a, b, d) { return c[d] }); return /cke_temp(comment)?/.test(a) ? a : "\x3c!--{cke_temp}" + (c.push(a) - 1) + "--\x3e" });
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, e) { return "\x3c" + c + d + "\x3e" + G(z(e), b) + "\x3c/" + c + "\x3e" })
        }
        var n;
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml", function(a) { a.data.dataValue.filterChildren(m.dataFilter, !0) }, null, null, 10);
            b.on("toHtml", function(a) {
                a = a.data;
                var b = a.dataValue,
            ...
            b.on("toDataFormat", function(a) { a.data.dataValue.filterChildren(m.htmlFilter, !0) }, null, null, 10);
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, c, d) {
                var f = this.editor,
                    e, p, m, h;
                b && "object" == typeof b ? (e = b.context, c = b.fixForBody, d = b.dontFilter, p = b.filter, m = b.enterMode, h = b.protectedWhitespaces) : e = b;
        ...
        n = function() {
            function a(c) { return CKEDITOR.tools.array.reduce(c.split(""), function(a, c) { var d = c.toLowerCase(),
                        f = c.toUpperCase(),
                        e = b(d);
                    d !== f && (e += "|" + b(f)); return a + ("(" + e + ")") }, "") }

            function b(a) { var c;
                c = a.charCodeAt(0); var d = c.toString(16);
                c = { htmlCode: "\x26#" + c + ";?", hex: "\x26#x0*" + d + ";?", entity: { "\x3c": "\x26lt;", "\x3e": "\x26gt;", ":": "\x26colon;" }[a] }; for (var f in c) c[f] && (a += "|" + c[f]); return a }
    ...
    (function() {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertHtmlIntoRange: function(a, b, c) { n(this, c || "html", a, b);
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    b.deleteContents(1);
                    b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({ tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1 }) ? L(b) : b.startContainer.is(CKEDITOR.dtd.$list) && y(b));
                    var g, B;
                    if (f)
                        for (;
                            (g = b.getCommonAncestor(0, 1)) && (B = CKEDITOR.dtd[g.getName()]) && (!B || !B[e]);)
                            if (g.getName() in
                ...
                setup: function() {
                    ...
                    this.attachListener(a, "beforeGetData", function() {
                        var b =
                            this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(t, function(a, b) { return b }));
                        a.setData(b, null, 1)
                    }, this);
                            ...
                            if (c in D && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                                ...
                                if (d.collapsed) a: {
                                    ...
                                    if (f && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(f, !c) && d.collapsed) {
                                        if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) { var p = d.startContainer.getChild(d.startOffset - (c ? 1 : 0)); if (p && p.type == CKEDITOR.NODE_ELEMENT && p.is("hr")) { a.fire("saveSnapshot");
                                                p.remove();
                                                b = !0; break a } }
                                        d = d.startPath().block;
        ...
        n = function() {
            ...
            function d(b, c) {
                ...
                for (D && e.push(" "); h < r; h++) g = f.getItem(h), a(g) && !g.is(k) ? e = e.concat(d(g, c)) : e.push(g);
                D && e.push(" ");
                return e
            }
            ...
            function f(b) { return b && a(b) && (b.is(B.$removeEmpty) || b.is("a") && !b.isBlockBoundary()) }
            ...
            return function(p, v, O, q) {
                ...
                if (!q.checkReadOnly()) {
                    ...
                    v = { type: v, dontFilter: E, editable: p, editor: F, range: q, blockLimit: w, mergeCandidates: [], zombies: [] };
                    var E = v.range,
                        w = v.mergeCandidates,
                        J = "html" === v.type,
                        x, t, z, y, G, V;
                    "text" == v.type &&
                        E.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (t = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", E.document), E.insertNode(t), E.setStartAfter(t));
                    z = new CKEDITOR.dom.elementPath(E.startContainer);
                    v.endPath = y = new CKEDITOR.dom.elementPath(E.endContainer);
                    if (!E.collapsed) { x = y.block || y.blockLimit; var aa = E.getCommonAncestor();
                        x && !x.equals(aa) && !x.contains(aa) && E.checkEndOfBlock() && v.zombies.push(x);
                        E.deleteContents() }
                    for (;
                        (G = e(E)) && a(G) && G.isBlockBoundary() && z.contains(G);) E.moveToPosition(G,
                        CKEDITOR.POSITION_BEFORE_END);
                    r(E, v.blockLimit, z, y);
                    t && (E.setEndBefore(t), E.collapse(), t.remove());
                    t = E.startPath();
                    if (x = t.contains(f, !1, 1)) V = E.splitElement(x), v.inlineStylesRoot = x, v.inlineStylesPeak = t.lastElement;
                    t = E.createBookmark();
                    J && (l(x), l(V));
                    (x = t.startNode.getPrevious(c)) && a(x) && f(x) && w.push(x);
                    (x = t.startNode.getNext(c)) && a(x) && f(x) && w.push(x);
                    for (x = t.startNode;
                        (x = x.getParent()) && f(x);) w.push(x);
                    E.moveToBookmark(t);
                    F.enterMode === CKEDITOR.ENTER_DIV && "" === F.getData(!0) && ((F = p.getFirst()) && F.remove(),
                        q.setStartAt(p, CKEDITOR.POSITION_AFTER_START), q.collapse(!0));
                    if (p = O) {
                        p = v.range;
                        if ("text" == v.type && v.inlineStylesRoot) { q = v.inlineStylesPeak;
                            F = q.getDocument().createText("{cke-peak}"); for (V = v.inlineStylesRoot.getParent(); !q.equals(V);) F = F.appendTo(q.clone()), q = q.getParent();
                            O = F.getOuterHtml().split("{cke-peak}").join(O) }
                        q = v.blockLimit.getName();
                        if (/^\s+|\s+$/.test(O) && "span" in CKEDITOR.dtd[q]) { var H = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            O = H + O + H }
                        O = v.editor.dataProcessor.toHtml(O, { context: null, fixForBody: !1, protectedWhitespaces: !!H, dontFilter: v.dontFilter, filter: v.editor.activeFilter, enterMode: v.editor.activeEnterMode });
                    ...
                    if (p) {
                        ...
                        var Z, E = G.getPosition(F),
                            w = !!G.getCommonAncestor(F) && E != CKEDITOR.POSITION_IDENTICAL && !(E & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
                            F = b(v.dataWrapper, v);
                        for (h(F, P); V < F.length; V++) {
                            E = F[V];
                            if (J = E.isLineBreak) J = P, x = q, y = z = void 0, E.hasBlockSibling ? J = 1 : (z = J.startContainer.getAscendant(B.$block, 1)) && z.is({ div: 1, p: 1 }) ? (y = z.getPosition(x), y ==
                            ...
                            if (J) O = 0 < V;
                                ...
                                J = P.startPath();
                                !E.isBlock && k(v.editor, J.block, J.blockLimit) && (I = g(v.editor)) && (I = p.createElement(I), I.appendBogus(), P.insertNode(I), CKEDITOR.env.needsBrFiller && (R = I.getBogus()) && R.remove(), P.moveToPosition(I, CKEDITOR.POSITION_BEFORE_END));
                                if ((J = P.startPath().block) && !J.equals(Q)) { if (R = J.getBogus()) R.remove(), H.push(J);
                                    Q = J }
                                E.firstNotAllowed &&
                                    (t = 1);
                                if (t && E.isElement) { J = P.startContainer; for (x = null; J && !B[J.getName()][E.name];) { if (J.equals(q)) { J = null; break }
                                        x = J;
                                        J = J.getParent() } if (J) x && (L = P.splitElement(x), v.zombies.push(L), v.zombies.push(x));
                                    else { x = q.getName();
                                        Z = !V;
                                        J = V == F.length - 1;
                                        x = d(E.node, x);
                                        z = [];
                                        y = x.length; for (var aa = 0, ca = void 0, X = 0, W = -1; aa < y; aa++) ca = x[aa], " " == ca ? (X || Z && !aa || (z.push(new CKEDITOR.dom.text(" ")), W = z.length), X = 1) : (z.push(ca), X = 0);
                                        J && W == z.length && z.pop();
                                        Z = z } }
                                if (Z) { for (; J = Z.pop();) P.insertNode(J);
                                    Z = 0 } else P.insertNode(E.node);
                                E.lastNotAllowed && V < F.length - 1 && ((L = w ? G : L) && P.setEndAt(L, CKEDITOR.POSITION_AFTER_START), t = 0);
                                P.collapse()
                            }
                        }
                        1 != F.length ? R = !1 : (R = F[0], R = R.isElement && "false" == R.node.getAttribute("contenteditable"));
                        R && (O = !0, J = F[0].node, P.setStartAt(J, CKEDITOR.POSITION_BEFORE_START), P.setEndAt(J, CKEDITOR.POSITION_AFTER_END));
                        v.dontMoveCaret = O;
                    ...
                    for (Z = R.createBookmark(); Q = v.zombies.pop();) Q.getParent() && (I = R.clone(), I.moveToElementEditStart(Q), I.removeEmptyBlocksAtEnd());
                    if (L)
                    ...
                    R.moveToBookmark(Z);
                    if (!v.dontMoveCaret) { for (Q = e(R); Q && a(Q) && !Q.is(B.$empty);) { if (Q.isBlockBoundary()) R.moveToPosition(Q, CKEDITOR.POSITION_BEFORE_END);
                            else { if (f(Q) && Q.getHtml().match(/(\s|&nbsp;)$/g)) { Y = null; break }
                                Y = R.clone();
        ...
        H = {
            ...
            bogus: { exclude: function(a) { var b = a.range.getBoundaryNodes(),
                        c = b.startNode,
                        b = b.endNode;!b || !G(b) || c && c.equals(b) || a.range.setEndBefore(b) } },
            tree: {
                ...
                table: function() {
                    function a(c) {
                        ...
                        g.guard = function(a, g) {
                            ...
                            else { if (l = !g) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!p || b(a, p)); if (!l && (l = g))
    ...
    (function() {
        ...
        function l(a) { return K(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 }
        ...
        function w(a, b) { return b ? a.replace(H, function(a, b) { return b ? " " : "" }) : a.replace(y, "") }
        ...
        function G(a) { var b = { 37: 1, 39: 1, 8: 1, 46: 1 }; return function(c) { var d = c.data.getKeystroke(); if (b[d]) { var e = a.getSelection().getRanges(),
                        f = e[0];
        ...
        var n = "function" != typeof window.getSelection,
            ...
            H = new RegExp(y + "( )?", "g"),
            I, m, C, K = CKEDITOR.dom.walker.invisible(1),
            A = function() {
                function a(b) {
                    return function(a) {
                        var c =
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                ...
                function b() { g.removeListener("mouseup", b);
                    r.removeListener("mouseup", b); var a = CKEDITOR.document.$.selection,
                        c = a.createRange(); "None" != a.type && c.parentElement() && c.parentElement().ownerDocument == f.$ && c.select() }
                ...
                var f = c.document,
                    ...
                    D = q.isInline(),
                    m, u;
                CKEDITOR.env.gecko && q.attachListener(q, "focus", function(a) { a.removeListener();
                    0 !== m && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == q.$ && (a = c.createRange(), a.moveToElementEditStart(q), a.select()) }, null, null, -2);
                ...
                q.attachListener(q, "mousedown", function() { m = 0 });
                if (CKEDITOR.env.ie || CKEDITOR.env.gecko || D) n ? q.attachListener(q, "beforedeactivate", a, null, null, -1) : q.attachListener(c, "selectionCheck", a, null, null, -1), q.attachListener(q, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur", function() { var a = u && (u.isFake || 2 > u.getRanges().length);
                        CKEDITOR.env.gecko && !D && a || (c.lockSelection(u), m = 1) }, null, null, -1),
                    q.attachListener(q, "mousedown", function() { m = 0 });
                if (CKEDITOR.env.ie && !D) {
                    var w;
                    q.attachListener(q, "mousedown", function(a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (w = c.window.getScrollPosition())) });
                    q.attachListener(q, "mouseup", function(a) { 2 == a.data.$.button && w && (c.document.$.documentElement.scrollLeft = w.x, c.document.$.documentElement.scrollTop = w.y);
                        w = null });
                    if ("BackCompat" != f.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            var t, z;
                            r.on("mousedown", function(a) {
                                function b(a) { a = a.data.$; if (t) { var c = l.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) {}
                                        t.setEndPoint(0 > z.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                        t.select() } }

                                function c() { r.removeListener("mousemove", b);
                                ...
                                if (a.getTarget().is("html") && a.$.y < r.$.clientHeight && a.$.x < r.$.clientWidth) {
                                    t = l.$.createTextRange();
                                    try { t.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                                    z =
                                        t.duplicate();
                                    r.on("mousemove", b);
                                    g.on("mouseup", c);
                ...
                if (D && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) { var y;
                    q.attachListener(q, "mousedown", function() { y = 1 });
                    q.attachListener(f.getDocumentElement(), "mouseup", function() { y && k.call(c);
                        y = 0 }) } else q.attachListener(CKEDITOR.env.ie ? q : f.getDocumentElement(), "mouseup", k, c);
                CKEDITOR.env.webkit && q.attachListener(f, "keydown", function(a) { switch (a.data.getKey()) {
                        case 13:
                        case 33:
                        case 34:
                        case 35:
        ...
        if (CKEDITOR.env.webkit) CKEDITOR.on("instanceReady", function(a) {
            ...
            b.on("beforeSetMode", function() { x(b.editable()) }, null, null, -1);
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                var a = n ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        if (-1 == r || r == e.length - 1 && 0 > n) { h.moveToElementText(d);
                            h.setEndPoint("StartToStart", b);
                            h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                            e = d.childNodes; if (!h) return f = e[e.length - 1], f.nodeType != CKEDITOR.NODE_TEXT ? { container: d, offset: e.length } : { container: f, offset: f.nodeValue.length }; for (d = e.length; 0 < h && 0 < d;) g = e[--d], g.nodeType == CKEDITOR.NODE_TEXT && (m = g, h -= g.nodeValue.length); return { container: m, offset: -h } }
                        h.collapse(0 < n ? !0 : !1);
                        h.setEndPoint(0 < n ? "StartToStart" : "EndToStart", b);
                        h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!h) return { container: d, offset: a(f) + (0 < n ? 0 : 1) };
                        for (; 0 < h;) try { g = f[0 < n ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, m = g), f = g } catch (u) { return { container: d, offset: a(f) } }
                    ...
                    var a = [],
                        b, c = this.getNative();
                    if (!c) return a;
                    for (var d = 0; d < c.rangeCount; d++) { var e = c.getRangeAt(d);
                ...
                return function(b) { var c = this._.cache,
                        d = c.ranges;
                    d || (c.ranges = d = new CKEDITOR.dom.rangeList(a.call(this))); return b ? t(new CKEDITOR.dom.rangeList(d.slice())) : d }
            }(),
            ...
            selectRanges: function(a) {
                ...
                if (a.length)
                    if (this.isLocked) { var k = CKEDITOR.document.getActive();
                        ...
                        if (p) this.fake(p);
                        else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !I && !a[0]._getTableElement({ table: 1 }).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a);
                        else {
                            if (n) {
                                ...
                                if ((c = b.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in M && (!c.is("a") ||
                                        !c.getText())) try { E = c.$.createControlRange();
                                    E.addElement(c.$);
                                    E.select(); return } catch (w) {}
                                ...
                                k ? (p = b.document.$.body.createTextRange(), p.moveToElementText(k.$),
                                    E.setEndPoint("EndToEnd", p), E.moveEnd("character", -1)) : (q = m.getNext(l), F = m.hasAscendant("pre"), q = !(q && q.getText && q.getText().match(p)) && (F || !m.hasPrevious() || m.getPrevious().is && m.getPrevious().is("br")), F = b.document.createElement("span"), F.setHtml("\x26#65279;"), F.insertBefore(m), q && b.document.createText("﻿").insertBefore(m));
                                b.setStartBefore(m);
                                m.remove();
                                a ? (q ? (E.moveStart("character", -1), E.select(), b.document.$.selection.clear()) : E.select(), b.moveToPosition(F, CKEDITOR.POSITION_BEFORE_START), F.remove()) :
                                ...
                                for (E = 0; E < a.length; E++) {
                                    if (E < a.length - 1 && (q = a[E], F = a[E + 1], p = q.clone(), p.setStart(q.endContainer, q.endOffset), p.setEnd(F.startContainer, F.startOffset), !p.collapsed && (p.shrink(CKEDITOR.NODE_ELEMENT, !0), b = p.getCommonAncestor(), p = p.getEnclosedNode(), b.isReadOnly() || p && p.isReadOnly()))) { F.setStart(q.startContainer, q.startOffset);
                                        a.splice(E--, 1); continue }
                                    b = a[E];
                                    F = this.document.$.createRange();
                                    b.collapsed &&
                                        CKEDITOR.env.webkit && u(b) && (p = e(this.root), b.insertNode(p), (q = p.getNext()) && !p.getPrevious() && q.type == CKEDITOR.NODE_ELEMENT && "br" == q.getName() ? (x(this.root), b.moveToPosition(q, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(p, CKEDITOR.POSITION_AFTER_END));
                                    F.setStart(b.startContainer.$, b.startOffset);
                                    try { F.setEnd(b.endContainer.$, b.endOffset) } catch (t) { if (0 <= t.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), F.setEnd(b.endContainer.$, b.endOffset);
                                        else throw t; }
                                    k.addRange(F)
                                }
                            }
            ...
            selectBookmarks: function(a) {
                for (var b = [], c, e = 0; e <
                    a.length; e++) { var f = new CKEDITOR.dom.range(this.root);
            ...
            removeAllRanges: function() { if (this.getType() != CKEDITOR.SELECTION_NONE) { var a = this.getNative(); try { a && a[n ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset() } }
        }
    })();
    "use strict";
    ...
    (function() {
            ...
            if (c.collapsed) e = L(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (r.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(w)) r = null, l = !0;
                        ...
                        if (z && r.data("cke-bookmark") || r.type === CKEDITOR.NODE_COMMENT) { r = r.getNextSourceNode(!0); continue }
                        if (v && m && CKEDITOR.dtd.$block[z])
                            for (var A = r, C = f(A), D = void 0, H = C.length, I = 0, A = H && new CKEDITOR.dom.range(A.getDocument()); I < H; ++I) { var D = C[I],
                                    K = CKEDITOR.filter.instances[D.data("cke-filter")]; if (K ? K.check(this) : 1) A.selectNodeContents(D), b.call(this, A) }
                        C = z ? !n[z] || y ? 0 : v && !m ? 0 : d(r, w, h, T) : 1;
                        if (C)
                            if (D = r.getParent(), C = h, H = g, I = k, !D || !(D.getDtd() || CKEDITOR.dtd.span)[H] && !I || C.parentRule &&
                                !C.parentRule(D)) l = !0;
                            else { if (t || z && CKEDITOR.dtd.$removeEmpty[z] && (r.getPosition(w) | T) != T || (t = c.clone(), t.setStartBefore(r)), z = r.type, z == CKEDITOR.NODE_TEXT || v || z == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) { for (var z = r, M;
                                        (l = !z.getNext(B)) && (M = z.getParent(), n[M.getName()]) && d(M, x, h, S);) z = M;
                                    t.setEndAfter(z) } }
                        else l = !0;
                        ...
                        for (var l = L(this, e), v = l.hasAttributes(), y = t.getCommonAncestor(), z = {}, C = {}, D = {}, H = {}, X, W, Y; l && y;) {
                            if (y.getName() == g) {
                                for (X in h.attributes) !H[X] &&
                                    (Y = y.getAttribute(W)) && (l.getAttribute(X) == Y ? C[X] = 1 : H[X] = 1);
                                for (W in h.styles) !D[W] && (Y = y.getStyle(W)) && (l.getStyle(W) == Y ? z[W] = 1 : D[W] = 1)
                            }
                            y = y.getParent()
                        }
                        for (X in C) l.removeAttribute(X);
                        for (W in z) l.removeStyle(W);
                        v && !l.hasAttributes() && (l = null);
                        l ? (t.extractContents().appendTo(l), t.insertNode(l), G.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), t.extractContents().appendTo(l), t.insertNode(l), G.call(this, l), l.remove(!0));
                        t = null
                    }
                }
                c.moveToBookmark(u);
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, k; h < f.elements.length && (k = f.elements[h]) && k != f.block && k != f.blockLimit; h++)
                    if (this.checkElementRemovable(k)) { var l;!e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k, g.match = l ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? z.call(this, k) : t(k, I(this)[k.getName()])) }
                if (g) {
                    e =
                        d;
                    ...
                    n = this;
                b(); for (f = d; !f.equals(m);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? z.call(this, f) : t(f, I(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g }
            a.moveToBookmark(c);
        ...
        function g(a) { var b = a.createBookmark(!0),
            ...
            this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = L(this, e, d), u(d, f));
            a.moveToBookmark(b) }
        ...
        function G(a) { for (var b = I(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0); for (var f in b)
                if (f != this.element)
                    for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e), d.isReadOnly() || t(d, b[f]) }
        ...
        function H(a, b) { for (var c in a) a[c] = a[c].replace(D, function(a, c) { return b[c] }) }

        function I(a) { if (a._.overrides) return a._.overrides; var b = a._.overrides = {},
        ...
        var A = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 },
            M = { a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1 },
            r = /\s*(?:;\s*|$)/,
            D = /#\((.+?)\)/g,
            B = CKEDITOR.dom.walker.bookmark(0,
                1),
        ...
        CKEDITOR.style.prototype = {
            apply: function(a) { if (a instanceof CKEDITOR.dom.document) return K.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode;
            ...
            checkElementMatch: function(a, b) {
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) { for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? C(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1; if (b) return !0 } else return !0
                }
                return !1
            },
        ...
        CKEDITOR.style.getStyleText = function(a) {
            ...
            for (var e in b) { var f = b[e],
                    g = (e + ":" + f).replace(r, ";"); "inherit" == f ? d += g : c += g }
        ...
        CKEDITOR.dom.elementPath = function(b, f) {
            ...
            do
                if (l.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (l.equals(f)) break;
                    if (!k && (u = l.getName(),
                            "true" == l.getAttribute("contenteditable") ? k = l : !h && d[u] && (h = l), a[u])) { if (u = !h && "div" == u) { a: { u = l.getChildren(); for (var e = 0, x = u.count(); e < x; e++) { var w = u.getItem(e); if (w.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[w.getName()]) { u = !0; break a } }
                                u = !1 }
                            u = !u }
                        u ? h = l : k = l }
                }
    ...
    */
    ...
    (function() {
        ...
        function M(a, b) { this.dialog = a; for (var c = b.contents, e = 0, d; d = c[e]; e++) c[e] = d && new N(a, d);
        ...
        function da(a) { for (var b in x) { for (var c = x[b], e = c.length - 1; 0 <= e; e--) c[e].dialog != a && c[e].uiElement != a || c.splice(e, 1);
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            this.on("hide", function() { B.removeListener("keydown", d);
        ...
        CKEDITOR.dialog.prototype = {
            ...
            addFocusable: function(a,
                b) { if ("undefined" == typeof b) b = this._.focusList.length, this._.focusList.push(new L(this, a, b));
        ...
        var G = function(a, b, c) { for (var e = 0, d; d = a[e]; e++)
                    if (d.id == b || c && d[c] && (d = G(d[c], b, c))) return d;
                return null },
            H = function(a, b, c, e, d) { if (c) { for (var f = 0, g; g = a[f]; f++) { if (g.id == c) return a.splice(f, 0, b), b; if (e && g[e] && (g = H(g[e], b, c, e, !0))) return g } if (d) return null }
                a.push(b); return b },
            I = function(a, b, c) {
    ...
    (function() {
        function e(a) { return a.getName && !a.hasAttribute("data-cke-temp") }
            ...
            init: function(a) {
                if (CKEDITOR.env.webkit) {
                    ...
                    a.on("contentDom", function(a) {
                        a = a.editor;
                        var c = a.editable();
                        c.attachListener(c, "keydown", function(a) { a.data.getKeystroke() == CKEDITOR.CTRL + 65 && CKEDITOR.tools.setTimeout(function() { b.addFillers(c) || b.removeFillers(c) }, 0) }, null, null, -1);
        ...
        CKEDITOR.plugins.widgetselection = {
            ...
            addSelectAllIntegration: function(a) { var b = this;
                a.editable().attachListener(a, "beforeCommandExec", function(d) { var c = a.editable(); "selectAll" == d.data.name && c && b.addFillers(c) }, null, null, 9999) }
        }
    })();
    (function() {
        function q(a) { this.editor = a;
            this.registered = {};
            this.instances = {};
            this.selected = [];
        ...
        function t(a, b, c) { CKEDITOR.dom.element.call(this, b.$);
            this.editor = a;
            this._ = {};
                ...
                exec: function(a, d) {
                    ...
                    if (f && f.name == b.name) f.edit();
                        ...
                        (h = a.widgets.initOn(f, b, d && d.startupData)) ? (f = h.once("edit",
                            function(b) { if (b.data.dialog) h.once("dialog", function(b) { b = b.data; var d, f;
                                    ...
                                    b.once("hide", function() { d.removeListener();
                                        f.removeListener() }) });
                                else e() }, null, null, 999), h.edit(), f.removeListener()) : e()
                    }
                },
        ...
        function aa(a, b) {
            ...
            function d(b, c, e) { var d = CKEDITOR.tools.getIndex(a._.upcasts, function(a) { return a[2] > e });
        ...
        function x(a, b) { a.focused = null; if (b.isInited()) { var c = b.editor.checkDirty();
            ...
            if ("wysiwyg" == this.editor.mode) {
                ...
                if (b) {
                    ...
                    if (a && a.initOnlyNew) c = this.initOnAll();
                            ...
                            c = [];
                        d = 0; for (e = l.count(); d < e; d++) { f = l.getItem(d); if (h = !this.getByElement(f, !0)) { a: { h = ba; for (var k = f; k = k.getParent();)
                                        if (h(k)) { h = !0; break a }
                                    h = !1 }
                                h = !h }
        ...
        function y(a) { if ("undefined" != typeof a.attributes && a.attributes["data-widget"]) { var b = z(a),
                    c = A(a),
                    d = !1;
        ...
        function A(a) { return a.find(function(a) { return 3 === a.type }, !0).pop() }

        function B(a, b, c) { if (!c.allowedContent && !c.disallowedContent) return null; var d = this._.filters[a];
        ...
        function ca(a) {
            ...
            return {
                ...
                iterator: function(a) {
                    ...
                    if (n = c.length) { if (a.attributes["data-cke-widget-upcasted"]) return !1;
        ...
        function D(a, b, c) { if (a.type == CKEDITOR.NODE_ELEMENT) { var d = CKEDITOR.dtd[a.name]; if (d && !d[c.name]) { var d = a.split(b),
                        e = a.parent;
                    b = d.getIndex();
                    a.children.length || (--b, a.remove());
                    d.children.length || d.remove(); return D(e, b, c) } }
            a.add(c, b) }

        function E(a, b) { return "boolean" == typeof a.inline ? a.inline : !!CKEDITOR.dtd.$inline[b] }

        function ba(a) { return a.hasAttribute("data-cke-temp") }

        function p(a, b, c, d) { var e = a.editor;
            e.fire("lockSnapshot");
        ...
        function da(a) { a.contextMenu && a.contextMenu.addListener(function(b) { if (b = a.widgets.getByElement(b, !0)) return b.fire("contextMenu", {}) }) }

        function ea(a, b) { return CKEDITOR.tools.trim(b) }
        ...
        function X(a) {
            function b(b) { 1 > a.selected.length || G(c, "cut" === b.name) } var c = a.editor;
            c.on("contentDom", function() { var a = c.editable();
                a.attachListener(a, "copy", b);
                a.attachListener(a, "cut", b) }) }

        function T(a) {
            function b() { var a = e.getSelection(); if (a && (a = a.getRanges()[0]) && !a.collapsed) { var b = c(a.startContainer),
                        d = c(a.endContainer);!b && d ? (a.setEndBefore(d.wrapper), a.select()) : b && !d && (a.setStartAfter(b.wrapper), a.select()) } }
            ...
            function d() { a.fire("checkSelection") }
            var e = a.editor;
            e.on("selectionCheck", d);
            e.on("contentDom", function() { e.editable().attachListener(e, "key", function() { setTimeout(d, 10) }) });
            ...
            e.on("dataReady", function() { H(a).commit() });
            e.on("blur", function() { var b;
                (b = a.focused) && x(a, b);
        ...
        function R(a) {
            ...
            b.on("toDataFormat", function(a) { if (a.data.downcastingSessionId)
                    for (var b = c[a.data.downcastingSessionId], f, h, l, k, g, m; f = b.shift();) { h = f.widget;
                        l = f.element;
                        k = h._.downcastFn && h._.downcastFn.call(h, l);
                        a.data.widgetsCopy && h.getClipboardHtml && (k = CKEDITOR.htmlParser.fragment.fromHtml(h.getClipboardHtml()), k = k.children[0]); for (m in f.editables) g = f.editables[m], delete g.attributes.contenteditable, g.setHtml(h.editables[m].getData());
                        k || (k = l);
                        f.wrapper.replaceWith(k) } }, null, null, 13);
        ...
        function Q(a) {
            var b = a.editor,
                c, d;
            b.on("toHtml", function(b) { var d = ca(a),
        ...
        function H(a) {
            ...
            return {
                ...
                commit: function() { var f = a.focused !== e,
                        h, l;
                    a.editor.fire("lockSnapshot"); for (f && (h = a.focused) && x(a, h); h = d.pop();) b.splice(CKEDITOR.tools.indexOf(b, h), 1), h.isInited() && (l = h.editor.checkDirty(), h.setSelected(!1), !l && h.editor.resetDirty());
                    f && e && (l = a.editor.checkDirty(), a.focused = e, a.fire("widgetFocused", { widget: e }), e.setFocused(!0), !l && a.editor.resetDirty()); for (; h = c.pop();) b.push(h), h.setSelected(!0);
        ...
        function I(a, b, c) { var d = 0;
            b = J(b); var e = a.data.classes || {},
                f; if (b) { for (e = CKEDITOR.tools.clone(e); f = b.pop();) c ? e[f] || (d = e[f] = 1) : e[f] && (delete e[f], d = 1);
                d && a.setData("classes", e) } }

        function K(a) { a.cancel() }

        function G(a, b) {
            var c = a.widgets.focused,
                d, e, f;
            u.hasCopyBin(a) || (e = new u(a, {
                beforeDestroy: function() {!b && c && c.focus();
        ...
        function J(a) { return (a = (a = a.getDefinition().attributes) && a["class"]) ? a.split(/\s+/) : null }

        function L() { var a = CKEDITOR.document.getActive(),
                b = this.editor,
                c = b.editable();
        ...
        function F(a) { var b = a.getSelectedHtml(!0); if (a.widgets.focused) return a.widgets.focused.getClipboardHtml();
            a.once("toDataFormat", function(a) { a.data.widgetsCopy = !0 }, null, null, -1); return a.dataProcessor.toDataFormat(b) }
        ...
        function Y(a, b) {
            ...
            a.on("key", function(b) { b = b.data.keyCode; if (13 == b) a.edit();
                else { if (b == CKEDITOR.CTRL + 67 || b == CKEDITOR.CTRL + 88) { G(a.editor, b == CKEDITOR.CTRL + 88); return } if (b in P || CKEDITOR.CTRL & b || CKEDITOR.ALT & b) return } return !1 }, null, null, 999);
        ...
        function N(a, b) { a.partSelectors || (a.partSelectors = a.parts); if (a.parts) { var c = {},
                    d, e; for (e in a.partSelectors) b || !a.parts[e] || "string" == typeof a.parts[e] ? (d = a.wrapper.findOne(a.partSelectors[e]), c[e] = d) : c[e] = a.parts[e];
                a.parts = c } }

        function ia(a) { var b = a.editables,
                c, d;
        ...
        function O(a) {
            if (!0 === a.mask) ma(a);
                ...
                var b =
                    ...
                    d, e;
                a.on("focus", function() { b.input();
                    d = a.editor.on("change", b.input);
                    e = a.on("blur", function() { d.removeListener();
                        e.removeListener() }) });
                a.editor.on("instanceReady", function() { setTimeout(function() { b.input() }, c) });
                a.editor.on("mode", function() { setTimeout(function() { b.input() }, c) });
                if (CKEDITOR.env.gecko) { var f = a.element.find("img");
                    CKEDITOR.tools.array.forEach(f.toArray(), function(a) { a.on("load", function() { b.input() }) }) }
                for (var h in a.editables) a.editables[h].on("focus",
                    function() { a.editor.on("change", b.input);
                        e && e.removeListener() }), a.editables[h].on("blur", function() { a.editor.removeListener("change", b.input) });
                b.input()
            }
        }

        function ma(a) { var b = a.wrapper.findOne(".cke_widget_mask");
        ...
        function na() {
            if (this.wrapper) {
                ...
                if (a &&
                    ...
                    b || (b = new CKEDITOR.dom.element("img", this.editor.document), b.setAttributes({ src: CKEDITOR.tools.transparentImageData, "class": "cke_reset cke_widget_partial_mask" }), this.wrapper.append(b));
                    this.mask = b;
                    var c = b.$,
                        d = a.$,
        ...
        function ja(a) {
            if (a.draggable) {
                var b = a.editor,
                    ...
                    d;
                c ? d = c.findOne("img") : (c = new CKEDITOR.dom.element("span", b.document), c.setAttributes({ "class": "cke_reset cke_widget_drag_handler_container", style: "background:rgba(220,220,220,0.5);background-image:url(" + b.plugins.widget.path + "images/handle.png);display:none;" }), d = new CKEDITOR.dom.element("img",
                    b.document), d.setAttributes({ "class": "cke_reset cke_widget_drag_handler", "data-cke-widget-drag-handler": "1", src: CKEDITOR.tools.transparentImageData, width: 15, title: b.lang.widget.move, height: 15, role: "presentation" }), a.inline && d.setAttribute("draggable", "true"), c.append(d), a.wrapper.append(c));
                ...
                if (!a.inline && (d.on("mousedown",
                        oa, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version)) d.on("dragstart", function(a) { a.data.preventDefault(!0) });
        ...
        function oa(a) {
            ...
            if (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT) {
                ...
                var w = c.greedySearch(),
                    r = CKEDITOR.tools.eventsBuffer(50, function() { n = d.locate(w);
                        k = d.sort(m, 1);
                        k.length && (e.prepare(w, n), e.placeLine(k[0]), e.cleanup()) });
                h.addClass("cke_widget_dragging");
                g.push(h.on("mousemove", function(a) { m = a.data.$.clientY;
                    r.input() }));
        ...
        function v(a) { a.element.data("cke-widget-data", encodeURIComponent(JSON.stringify(a.data))) }
        ...
        function pa() {
            ...
            function c(a) {
                function b(a, c, d) { for (var e = a.length, f = 0; f < e;) { if (c.call(d, a[f], f, a)) return a[f];
                        f++ } }
        ...
        CKEDITOR.plugins.add("widget", {
            ...
            beforeInit: function(a) { void 0 !== CKEDITOR.document.$.querySelectorAll && (a.widgets = new q(a)) },
        ...
        q.prototype = {
            ...
            add: function(a, b) {
                ...
                aa(this, b);
                this.registered[a] = b;
                if (b.dialog && c.plugins.dialog) var d = CKEDITOR.on("dialogDefinition", function(a) { a = a.data.definition; var f = a.dialog;
                    a.getMode || f.getName() !== b.dialog || (a.getMode = function() { var a = f.getModel(c); return a && a instanceof CKEDITOR.plugins.widget && a.ready ? CKEDITOR.dialog.EDITING_MODE : CKEDITOR.dialog.CREATION_MODE });
                    d.removeListener() });
                return b
            },
            addUpcastCallback: function(a) { this._.upcastCallbacks.push(a) },
            checkSelection: function() { if (this.editor.getSelection()) { var a = this.editor.getSelection(),
            ...
            destroy: function(a, b) { this.widgetHoldingFocusedEditable === a && p(this, a, null, b);
                a.destroy(b);
        ...
        g.prototype = {
            ...
            applyStyle: function(a) { I(this, a, 1) },
            checkStyleActive: function(a) { a = J(a); var b; if (!a) return !1; for (; b = a.pop();)
            ...
            edit: function() {
                ...
                this.editor.openDialog(a.dialog, function(a) {
                    var d, e;
                    !1 !== b.fire("dialog",
                        a) && (d = a.on("show", function() { a.setupContent(b) }), e = a.on("ok", function() { var d, e = b.on("data", function(a) { d = 1;
            ...
            initEditable: function(a, b) {
                ...
                return c && c.is(CKEDITOR.dtd.$editable) ? (c = new t(this.editor, c, { filter: B.call(this.repository, this.name, a, b) }), this.editables[a] = c, c.setAttributes({ contenteditable: "true", "data-cke-widget-editable": a, "data-cke-enter-mode": c.enterMode }), c.filter && c.data("cke-filter",
            ...
            focus: function() { var a = this.editor.getSelection(); if (a) { var b = this.editor.checkDirty();
                ...
                this.editor.focus() },
            refreshMask: function() { O(this) },
            refreshParts: function(a) { N(this, "undefined" !== typeof a ? a : !0) },
            removeClass: function(a) { this.element.removeClass(a);
                this.wrapper.removeClass(g.WRAPPER_CLASS_PREFIX + a) },
            removeStyle: function(a) { I(this, a, 0) },
            setData: function(a, b) {
                var c = this.data,
                    d = 0;
            ...
            updateDragHandlerPosition: function() {
                ...
                c && b.x == c.x && b.y == c.y || (c = a.checkDirty(), a.fire("lockSnapshot"), this.dragHandlerContainer.setStyles({ top: b.y + "px", left: b.x + "px" }), this.dragHandlerContainer.removeStyle("display"), a.fire("unlockSnapshot"), !c && a.resetDirty(), this._.dragHandlerOffset = b)
            }
        };
        ...
        var u = CKEDITOR.tools.createClass({
            $: function(a, b) { this._.createCopyBin(a, b);
    ...
    (function() {
        function p(c) { var a = c.widgets,
                b = c.focusManager.currentActive; if (c.focusManager.hasFocus) { if (a.focused) return a.focused; if (b instanceof CKEDITOR.plugins.widget.nestedEditable) return a.getByElement(b) } }

        function l(c, a) { return c.features && -1 !== CKEDITOR.tools.array.indexOf(c.features, a) }

        function t(c, a) { return CKEDITOR.tools.array.reduce(CKEDITOR.tools.object.keys(c), function(b, d) { var f = c[d];
                l(f, a) && b.push(f); return b }, []) }
        ...
        function u(c, a) {
            a = CKEDITOR.tools.object.merge({
                ...
                upcasts: { figure: function(b) { if (1 === b.find("img", !0).length) return b } }
            }, a);
            a.upcast = CKEDITOR.tools.object.keys(a.upcasts).join(",");
            return a
        }

        function m(c) { this.wrapper = CKEDITOR.dom.element.createFromHtml(c || '\x3cdiv class\x3d"cke_loader"\x3e\x3c/div\x3e') }

        function n() { m.call(this, '\x3cdiv class\x3d"cke_loader"\x3e\x3cdiv class\x3d"cke_bar" styles\x3d"transition: width ' + q / 1E3 + 's"\x3e\x3c/div\x3e\x3c/div\x3e');
        ...
        var r = !1,
            v = {
                caption: function() {
                    ...
                    function a(b, a) { b.data("cke-caption-active", a);
                        b.data("cke-caption-hidden", !a) }
                    return {
                        setUp: function(b) {
                            function a(d) { var e = (d = "blur" === d.name ? b.elementPath() : d.data.path) ? d.lastElement : null;
                                d = t(b.widgets.instances, "caption"); if (!b.filter.check("figcaption")) return CKEDITOR.tools.array.forEach(c, function(a) { a.removeListener() });
                                CKEDITOR.tools.array.forEach(d, function(a) { a._refreshCaption(e) }) } var c = [];
                ...
                upload: function() {
                    var c = {
                            ...
                            a.on("paste", function(d) {
                                ...
                                if (!a.readOnly && ("drop" === f || "paste" === f && e)) {
                                    ...
                                    for (var k = 0; k < e; k++) f = g.getFile(k), CKEDITOR.fileTools.isTypeSupported(f, b.supportedTypes) &&
                                        h.push(f);
                                    h.length && (d.cancel(), d.stop(), CKEDITOR.tools.array.forEach(h, function(d, f) { var g = c._spawnLoader(a, d, b, d.name);
                        ...
                        init: function() { this.once("ready", function() { var a = this.data.uploadId; "undefined" !== typeof a && (a = this.editor.uploadRepository.loaders[a]) && this._beginUpload(this, a) }) },
                        ...
                        _spawnLoader: function(a, b, d, c) { var g = d.loadMethod || "loadAndUpload";
                            ...
                            a[g](d.uploadUrl, d.additionalRequestParameters); return a },
                        _beginUpload: function(a, b) {
                            function d() { a.isInited() && a.setData("uploadId", void 0);
                                a.wrapper.removeClass("cke_widget_wrapper_uploading") }

                            function c() { d();!1 !== a.fire("uploadFailed", { loader: b }) && a.editor.widgets.del(a) }
                            var g = { uploaded: function() { d();
                                        a.fire("uploadDone", { loader: b }) }, abort: c, error: c },
                                e = [];
                            e.push(b.on("abort",
                                g.abort));
                            e.push(b.on("error", g.error));
                            e.push(b.on("uploaded", g.uploaded));
                            this.on("destroy", function() { CKEDITOR.tools.array.filter(e, function(a) { a.removeListener(); return !1 }) });
                ...
                link: function() {
                    function c(a) { a.addMenuGroup("imagebase", 10);
                        a.addMenuItem("imagebase", { label: a.lang.link.menu, command: "link", group: "imagebase" }) }

                    function a(a, c, b) {
                        return function() {
                            if (b &&
                                l(b, "link")) { a.stop(); var e = {};
                                c.commitContent(e);
                                b.setData("link", e) }
                        }
                    }

                    function b(a, c, b) { a.getCommand("unlink").on(c, function(c) { var f = p(a);
                    ...
                    return {
                        ...
                        setUp: function(d) {
                            d.plugins.link && (d.contextMenu &&
                                c(d), d.on("dialogShow", function(c) { var b = p(d),
                                        e = c.data,
                                        h, k;
                                    b && l(b, "link") && "link" === e._.name && (h = e.getContentElement("info", "linkDisplayText").getElement().getParent().getParent(), e.setupContent(b.data.link || {}), h.hide(), k = e.once("ok", a(c, e, b), null, null, 9), e.once("hide", function() { k.removeListener();
                                        h.show() })) }), b(d, "exec", function(a, c, b) { c.setData("link", null);
                                    a.refresh(b, b.elementPath()) }), b(d, "refresh", function(a, b) { a.setState(b.parts.link ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED) }))
                        },
                        data: function(a) {
                            var b = this.editor,
                                c = a.data.link,
        ...
        m.prototype = {
            ...
            bindLoader: function(c) {
                function a() { b && (CKEDITOR.tools.array.forEach(b, function(a) { a.removeListener() }), b = null) }
                var b = [],
                    d = CKEDITOR.tools.eventsBuffer(q, function() { c.uploadTotal && this.updated(c.uploaded / c.uploadTotal) }, this);
                b.push(c.on("update",
                    d.input, this));
        ...
        n.prototype = new m;
        n.prototype.updated = function(c) { c = Math.round(100 * c);
            c = Math.max(c, 0);
            c = Math.min(c, 100);
        ...
        CKEDITOR.plugins.imagebase = {
            ...
            addImageWidget: function(c, a, b) { a = c.widgets.add(a, u(c, b));
                c.addFeature(a) },
            addFeature: function(c, a, b) {
                function d(a, b) { if (a || b) return function() { a && a.apply(this, arguments);
    ...
    (function() {
        var f = !1;
        CKEDITOR.plugins.add("balloonpanel", { init: function() { f || (CKEDITOR.document.appendStyleSheet(this.path + "skins/" + CKEDITOR.skin.name + "/balloonpanel.css"), f = !0) } });
        CKEDITOR.ui.balloonPanel = function(a, b) {
            this.editor = a;
            CKEDITOR.tools.extend(this, { width: 360, height: "auto", triangleWidth: 20, triangleHeight: 20, triangleMinDistance: 40 }, b, !0);
            this.templates = {};
            ...
            this.rect = { visible: !1 };
            this.build();
            a.on("destroy", function() { this.destroy() }, this)
        };
        CKEDITOR.ui.balloonPanel.prototype = {
            ...
            build: function() {
                ...
                this.parts.close.on("click", function(a) { this.hide();
                    a.data.preventDefault() }, this)
            },
            ...
            move: function(a, b) { this.rect.left = b;
                this.rect.top = a;
                this.parts.panel.setStyles({ left: CKEDITOR.tools.cssLength(b), top: CKEDITOR.tools.cssLength(a) }) },
            attach: function() {
                function a(a, b) { var d = Math.max(0, Math.min(a.right, b.right) - Math.max(a.left, b.left)),
                        c = Math.max(0, Math.min(a.bottom, b.bottom) - Math.max(a.top, b.top)); return d * c }

                function b(a, b, c, e) { a = { top: a, left: b };
                    a.right = a.left + c;
                    a.bottom = a.top + e; return a }
                ...
                function z(a) { var b = f(a, !0);
                    ...
                    a.y && (b.y = a.y);
                    a.top = b.top;
                    a.height = b.height; return [b, a] }

                function f(a, b) { var c = b ? a[0] : a[a.length - 1],
                        e = b ? "top" : "bottom"; return CKEDITOR.tools.array.filter(a, function(a) { if (a[e] === c[e]) return a }) }
                var u, v, x, q, A = { right: "left", top: "bottom", topLeft: "bottomLeft", topRight: "bottomRight", bottom: "top", bottomLeft: "topLeft", bottomRight: "topRight", left: "right" };
                return function(p, l) {
                    if (p instanceof CKEDITOR.dom.selection) { var d = p.getRanges(),
                            d = p.isFake && p.isInTable() ? CKEDITOR.tools.array.map(d, function(a) { return a.getClientRects(!0)[0] }) : d[d.length - 1].getClientRects(!0),
                            e = d[0],
                            f = d[d.length - 1],
                            r;
                    ...
                    var t = q ? x.getClientRect(!0) : v.getClientRect(!0),
                        ...
                        m = { top: Math.max(t.top, w.y), left: Math.max(t.left, w.x), right: Math.min(t.right, y.width + w.x), bottom: Math.min(t.bottom, y.height + w.y) };
                    ...
                    r ? (CKEDITOR.tools.array.forEach(r, function(a) { this._adjustElementRect(a, q ? m : t) }, this), g = this._getAlignments(r[0], d, e), 1 < r.length && (g["bottom hcenter"] = this._getAlignments(r[1], d, e)["bottom hcenter"]), h = { "top hcenter": !0, "bottom hcenter": !0 }) : (this._adjustElementRect(g, q ? m : t), g = this._getAlignments(g, d, e));
                    for (var n in h || g) { h = b(g[n].top, g[n].left, d, e);
                        h = g[n].areaDifference = f - a(h, m); if (0 === h) { k = n; break }
                        k || (k = n);
            ...
            resize: function(a, b) { this.rect.width = a;
                this.rect.height = b;
            ...
            getHeight: function() { return "auto" === this.rect.height ? this.parts.panel.getClientRect().height : this.rect.height },
            ...
            registerFocusable: function(a) { this.editor.focusManager.add(a);
                this.focusables[a.getUniqueId()] = a },
            deregisterFocusable: function(a) { this.editor.focusManager.remove(a);
                delete this.focusables[a.getUniqueId()] },
            addShowListener: function(a) { var b = CKEDITOR.tools.getNextNumber();
                this.showListeners[b] = a;
                this.rect.visible && this.activateShowListener(b); var c = this; return { removeListener: function() { c.removeShowListener(b) } } },
            removeShowListener: function(a) { this.deactivateShowListener(a);
                delete this.showListeners[a] },
            activateShowListener: function(a) { this.activeShowListeners[a] = this.showListeners[a].call(this) },
            deactivateShowListener: function(a) { this.activeShowListeners[a] && this.activeShowListeners[a].removeListener();
            ...
            destroy: function() { this.deactivateShowListeners();
            ...
            _getViewPaneRect: function(a) { var b = a.getScrollPosition();
                a = a.getViewPaneSize(); return { top: b.y, bottom: b.y + a.height, left: b.x, right: b.x + a.width } }
        };
        CKEDITOR.event.implementOn(CKEDITOR.ui.balloonPanel.prototype)
    })();
    (function() {
        function g(a, b) { this.editor = a;
            this.options = b;
        ...
        CKEDITOR.ui.balloonToolbarView = function(a, b) { b = CKEDITOR.tools.extend(b || {}, { width: "auto", triangleWidth: 7, triangleHeight: 7 });
            CKEDITOR.ui.balloonPanel.call(this, a, b);
            this._listeners = [] };
        CKEDITOR.ui.balloonToolbar = function(a, b) { this._view = new CKEDITOR.ui.balloonToolbarView(a, b);
            this._items = {} };
        CKEDITOR.ui.balloonToolbar.prototype.attach = function(a, b) { this._view.renderItems(this._items);
            this._view.attach(a, { focusElement: !1, show: !b }) };
        CKEDITOR.ui.balloonToolbar.prototype.show =
            function() { this._view.show() };
        CKEDITOR.ui.balloonToolbar.prototype.hide = function() { this._view.hide() };
        CKEDITOR.ui.balloonToolbar.prototype.reposition = function() { this._view.reposition() };
        CKEDITOR.ui.balloonToolbar.prototype.addItem = function(a, b) { this._items[a] = b };
        CKEDITOR.ui.balloonToolbar.prototype.addItems = function(a) { for (var b in a) this.addItem(b, a[b]) };
        CKEDITOR.ui.balloonToolbar.prototype.getItem = function(a) { return this._items[a] };
        CKEDITOR.ui.balloonToolbar.prototype.deleteItem = function(a) {
            this._items[a] &&
                (delete this._items[a], this._view.renderItems(this._items))
        };
        CKEDITOR.ui.balloonToolbar.prototype.destroy = function() { for (var a in this._items) this._items[a].destroy && this._items[a].destroy(), this.deleteItem(a);
            this._pointedElement = null;
            this._view.destroy() };
        CKEDITOR.ui.balloonToolbar.prototype.refresh = function() { for (var a in this._items) { var b = this._view.editor.getCommand(this._items[a].command);
        ...
        g.prototype = {
            ...
            show: function(a) { a && this.toolbar.attach(a);
                this.toolbar.show() },
            hide: function() { this.toolbar.hide() },
            refresh: function() { this.toolbar.refresh() },
            _matchRefresh: function(a, b) { var c = null;
                this.options.refresh && (c = this.options.refresh(this.editor, a, b) || null) && !1 === c instanceof CKEDITOR.dom.element && (c = a && a.lastElement || this.editor.editable()); return c },
            ...
            _matchElement: function(a) { return this.options.cssSelector && l && a.$[l](this.options.cssSelector) ? a : null },
            _loadButtons: function() { var a = this.options.buttons;
                a && (a = a.split(","), CKEDITOR.tools.array.forEach(a, function(a) { var c = this.editor.ui.create(a);
                    c && this.toolbar.addItem(a, c) }, this)) }
        };
        h.prototype = {
            create: function(a) {
            ...
            check: function(a) {
                function b(a, b, c) { f(a, function(a) { if (!k || k.options.priority > a.options.priority) { var d = b(a, c);
                            d instanceof CKEDITOR.dom.element && (g = d, k = a) } }) }

                function c(a, b) { return a._matchElement(b) }
                a || (a = this.editor.getSelection(), CKEDITOR.tools.array.forEach(a.getRanges(), function(a) { a.shrink(CKEDITOR.SHRINK_ELEMENT, !0) }));
                if (a) {
                    ...
                    b(this._contexts, function(a) { return a._matchWidget() });
                    if (e)
                        for ((d = a.getSelectedElement()) && !d.isReadOnly() && b(this._contexts, c, d), d = 0; d < e.elements.length; d++) { var h = e.elements[d];
            ...
            destroy: function() { CKEDITOR.tools.array.forEach(this._listeners, function(a) { a.removeListener() });
        ...
        CKEDITOR.plugins.add("balloontoolbar", {
            ...
            isSupportedEnvironment: function() { return !CKEDITOR.env.ie || 8 < CKEDITOR.env.version },
            beforeInit: function(a) { n || (CKEDITOR.document.appendStyleSheet(this.path + "skins/default.css"), CKEDITOR.document.appendStyleSheet(this.path + "skins/" + CKEDITOR.skin.name + "/balloontoolbar.css"), n = !0);
                a.balloonToolbars = new CKEDITOR.plugins.balloontoolbar.contextManager(a) },
            init: function(a) {
                a.balloonToolbars = new CKEDITOR.plugins.balloontoolbar.contextManager(a);
                m || (m = !0, CKEDITOR.ui.balloonToolbarView.prototype = CKEDITOR.tools.extend({}, CKEDITOR.ui.balloonPanel.prototype), CKEDITOR.ui.balloonToolbarView.prototype.build = function() { CKEDITOR.ui.balloonPanel.prototype.build.call(this);
                        this.parts.panel.addClass("cke_balloontoolbar");
                        this.parts.title.remove();
                        this.deregisterFocusable(this.parts.close);
                        this.parts.close.remove() }, CKEDITOR.ui.balloonToolbarView.prototype.show = function() {
                        function a() { this.reposition() }
                    ...
                    }, CKEDITOR.ui.balloonToolbarView.prototype.hide = function() { this._detachListeners();
                    ...
                    function() { this._listeners.length && (CKEDITOR.tools.array.forEach(this._listeners, function(a) { a.removeListener() }), this._listeners = []) }, CKEDITOR.ui.balloonToolbarView.prototype.destroy = function() { this._deregisterItemFocusables();
                        CKEDITOR.ui.balloonPanel.prototype.destroy.call(this);
                        this._detachListeners() }, CKEDITOR.ui.balloonToolbarView.prototype.renderItems = function(a) {
                        var c = [],
                        ...
                        CKEDITOR.tools.array.forEach(this.parts.content.find("a").toArray(), function(a) { a.setAttribute("draggable", "false");
                            this.registerFocusable(a) }, this)
                    }, CKEDITOR.ui.balloonToolbarView.prototype.attach =
                    function(a, c) { this._pointedElement = a;
                        CKEDITOR.ui.balloonPanel.prototype.attach.call(this, a, c) }, CKEDITOR.ui.balloonToolbarView.prototype._deregisterItemFocusables = function() { var a = this.focusables,
                            c; for (c in a) this.parts.content.contains(a[c]) && this.deregisterFocusable(a[c]) })
            }
        });
    ...
    (function() {
        ...
        CKEDITOR.xml = function(c) { var a = null; if ("object" == typeof c) a = c;
            else if (c = (c || "").replace(/&nbsp;/g, " "), "ActiveXObject" in window) { try { a = new ActiveXObject("MSXML2.DOMDocument") } catch (b) { try { a = new ActiveXObject("Microsoft.XmlDom") } catch (d) {} }
                a && (a.async = !1, a.resolveExternals = !1, a.validateOnParse = !1, a.loadXML(c)) } else window.DOMParser && (a = (new DOMParser).parseFromString(c, "text/xml"));
            this.baseXml = a };
        CKEDITOR.xml.prototype = {
            selectSingleNode: function(c, a) {
                var b =
                    this.baseXml;
                if (a || (a = b)) { if ("selectSingleNode" in a) return a.selectSingleNode(c); if (b.evaluate) return (b = b.evaluate(c, a, null, 9, null)) && b.singleNodeValue || null }
                return null
            },
            selectNodes: function(c, a) { var b = this.baseXml,
                    d = []; if (a || (a = b)) { if ("selectNodes" in a) return a.selectNodes(c); if (b.evaluate && (b = b.evaluate(c, a, null, 5, null)))
                        for (var e; e = b.iterateNext();) d.push(e) } return d },
    ...
    (function() {
        ...
        CKEDITOR.ajax = function() {
            function g() { if (!CKEDITOR.env.ie || "file:" != location.protocol) try { return new XMLHttpRequest } catch (a) {}
                try { return new ActiveXObject("Msxml2.XMLHTTP") } catch (b) {} try { return new ActiveXObject("Microsoft.XMLHTTP") } catch (f) {} return null }

            function h(a) { return 4 == a.readyState && (200 <= a.status && 300 > a.status || 304 == a.status || 0 === a.status || 1223 == a.status) }

            function k(a) { return h(a) ? a.responseText : null }
            ...
            function l(a, b, f) { var d = !!b,
                    c = g(); if (!c) return null;
                c.open("GET", a, d);
                d && (c.onreadystatechange = function() { 4 == c.readyState && (b(f(c)), c = null) });
                c.send(null); return d ? "" : f(c) }

            function n(a, b, f, d, c) { var e = g(); if (!e) return null;
                e.open("POST", a, !0);
                e.onreadystatechange = function() { 4 == e.readyState && (d && d(c(e)), e = null) };
    ...
    (function() {
        CKEDITOR.plugins.add("cloudservices", {
            ...
            onLoad: function() {
                function a(a, b, f, d) { c.call(this, a, b, f);
                    this.customToken = d } var c = CKEDITOR.fileTools.fileLoader;
            ...
            beforeInit: function(a) {
                var c = a.config.cloudServices_tokenUrl,
                    e = { token: null, REFRESH_INTERVAL: a.CLOUD_SERVICES_TOKEN_INTERVAL || 36E5, refreshToken: function() { CKEDITOR.ajax.load(c, function(b) { b && (e.token = b) }) }, init: function() { this.refreshToken(); var b = window.setInterval(this.refreshToken, this.REFRESH_INTERVAL);
                            a.once("destroy", function() { window.clearInterval(b) }) } };
                ...
                a.on("fileUploadResponse", function(a) { var c = a.data.fileLoader,
                        d = c.xhr,
                        e; if (c instanceof CKEDITOR.plugins.cloudservices.cloudServicesLoader) { a.stop(); try { e = JSON.parse(d.responseText), a.data.response = e } catch (g) { CKEDITOR.warn("filetools-response-error", { responseText: d.responseText }) } } })
            }
        });
        CKEDITOR.plugins.cloudservices = { cloudServicesLoader: null }
    })();
    (function() {
        function f(a) { return CKEDITOR.tools.capitalize(a, !0) }

        function p(a, c) {
            function b(a) { return function(b, d) { var c = b.widgets.focused,
            ...
            function e(a, c, d, g) {
                ...
                c.refresh = b(function(a,
                    b, c) { return this.style.checkActive(c, b) });
                a.addCommand(g, c);
                c = a.getCommand(g);
                c.enable = function() {};
            ...
            a.addCommand("easyimageAlt", new CKEDITOR.dialogCommand("easyimageAlt", { startDisabled: !0, contextSensitive: !0, refresh: b() }));
            (function(b) {
                function c(a, b) { var d = a.match(/^easyimage(.+)$/); if (d) { var e = (d[1][0] || "").toLowerCase() + d[1].substr(1); if (d[1] in b) return d[1]; if (e in b) return e } return null }
                a.on("afterCommandExec", function(d) {
                    c(d.data.name, b) && (a.forceNextSelectionCheck(),
                        a.selectionChange(!0))
                });
                a.on("beforeCommandExec", function(d) { c(d.data.name, b) && d.data.command.style.checkActive(d.editor.elementPath(), a) && (d.cancel(), a.focus()) });
                for (var d in b) e(a, d, b[d], "easyimage" + f(d))
            })(c)
        }

        function q(a) { var c = a.config.easyimage_toolbar;
            a.plugins.contextmenu && (c.split && (c = c.split(",")), a.addMenuGroup("easyimage"), CKEDITOR.tools.array.forEach(c, function(b) { b = a.ui.items[b];
        ...
        function r(a) {
            ...
            b.split && (b = b.split(","));
            CKEDITOR.tools.array.forEach(b, function(b) { b = c.ui.items[b];
        ...
        function t(a, c) {
            var b = a.config,
                ...
                b = {
                    ...
                    upcasts: { figure: function(a) { if ((!e || a.hasClass(e)) && 1 === a.find("img", !0).length) return a } },
                    init: function() {
                        function b(a, c) { var e = a.$; if (e.complete && e.naturalWidth) return c(e.naturalWidth);
                            a.once("load", function() { c(e.naturalWidth) }) }
                        var c = this.parts.image;
                        c && !c.$.complete && b(c, function() { a._.easyImageToolbarContext.toolbar.reposition() });
                        ...
                        this.on("uploadStarted", function() { var a = this;
                            b(a.parts.image, function(b) { a.parts.image.hasAttribute("width") || (a.editor.fire("lockSnapshot"), a.parts.image.setAttribute("width", b), a.editor.fire("unlockSnapshot")) }) });
                        ...
                        this.on("uploadFailed", function() { alert(this.editor.lang.easyimage.uploadFailed) });
                        this._loadDefaultStyle()
                    },
                    _loadDefaultStyle: function() { var b = !1,
                            e = a.config.easyimage_defaultStyle,
                            d; for (d in c) { var g = a.getCommand("easyimage" + f(d));!b && g && g.style && -1 !== CKEDITOR.tools.array.indexOf(g.style.group, "easyimage") && this.checkStyleActive(g.style) && (b = !0) }!b && e && a.getCommand("easyimage" + f(e)) && this.applyStyle(a.getCommand("easyimage" + f(e)).style) }
                };
        ...
        function v(a) {
            a.ui.addButton("EasyImageUpload", { label: a.lang.easyimage.commands.upload, command: "easyimageUpload", toolbar: "insert,1" });
        ...
        var n = !1,
            l = ["jpeg", "png", "gif", "bmp"];
        CKEDITOR.plugins.easyimage = { _parseSrcSet: function(a) { var c = [],
                    b; for (b in a) "default" !== b && c.push(a[b] + " " + b + "w"); return c.join(", ") } };
        CKEDITOR.plugins.add("easyimage", {
            ...
            init: function(a) { this.isSupportedEnvironment() && (n || (CKEDITOR.document.appendStyleSheet(this.path + "styles/easyimage.css"), n = !0), a.addContentsCss && a.addContentsCss(this.path + "styles/easyimage.css")) },
            afterInit: function(a) {
                if (this.isSupportedEnvironment()) {
                    ...
                    u(a);
                    p(a, c);
                    a.ui.addButton("EasyImageAlt", { label: a.lang.easyimage.commands.altText, command: "easyimageAlt", toolbar: "easyimage,3" });
                    ...
                    a._.easyImageToolbarContext = a.balloonToolbars.create({ buttons: c.join ? c.join(",") : c, widgets: ["easyimage"] });
                    v(a)
                }
            }
        });
